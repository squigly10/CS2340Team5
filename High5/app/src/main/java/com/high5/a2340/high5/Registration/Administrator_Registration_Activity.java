...
/**
 *  Activity for registering a new Administrative User
 *  @author High5
 *  @version 1.4
 */
public class Administrator_Registration_Activity extends AppCompatActivity implements View
        .OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> userTypeAdapter = new ArrayAdapter(this,android.R.layout
                .simple_spinner_item, MainActivity.legalUserTypes);
    ...
    private void createAccount() {
        ...
        Task<AuthResult> authTask = firebaseAuth.createUserWithEmailAndPassword(usrString.trim(),
                passString.trim());
        authTask.addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (userID != null) {
                                User newUser = new User(userEmail.getText().toString().trim(),
                                        userPassword.getText().toString().trim(), userType);
                                FirebaseDatabase.getInstance().getReference().child("users")
                                        .child(userID).setValue(newUser);

                                startActivity(new Intent(
                                        Administrator_Registration_Activity.this,
                                        MainActivity.class));
                            }
                        } else {
                            ...
                            if (task.getException().getMessage().contains("The email address " +
                                ...
                                Toast.makeText(Administrator_Registration_Activity.this,
                                        "The email address is already in use by " +
                                                "another account.",
